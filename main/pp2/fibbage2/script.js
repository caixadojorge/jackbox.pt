...
const zx = BC.extend({
    ...
    reaction14: ["Una correcta, tres incorrectas. No tienes remedio, pero admiramos que regreses por más castigo.", "Una de cuatro. Un ratón con los ojos vendados podría hacerlo mejor. (Hicimos la investigación).", "Viendo el lado positivo, probablemente seas una buena persona.", "Una de cuatro. ¡Veamos si eso puede convertirse en una de siete! ¡Sí!", "Solo estás presionando botones, ¿no es así?"],
    reaction24: ["Dos de cuatro. ¡Solo hazlo el doble de bien la próxima vez y podrás hacerlo!", "Dos de cuatro. A este ritmo, ¡tendrás 3,5 bien!", "¡Sigue alcanzando la mitad del camino hacia las estrellas! ¡Sé el mejor mediocre que puedas ser!", "¡Si tienes autoestima, todo es posible! Excepto un puntaje perfecto. Eso se ha ido hace mucho en este punto.", "Dos de cuatro. Has visto la cara de la adversidad. ¡Dale una bofetada y sigue jugando!"],
    ...
    reaction25: ["Solo dos preguntas más y puede acabar tu sufrimiento.", "Okey, la estrategia la próxima vez es ignorar tus instintos.", "¡¡¡Incluso si hubieras acertado el doble, no sería suficiente!!!", "No es bueno. Pero, como dijo una vez Gandhi, \u201C¡Sigue jugando!\u201D", "Solo dos correctas. Si puedes encontrar la voluntad de seguir viviendo, es obvio que todavía puedes seguir jugando."],
    reaction35: ["Todavía no va a suceder, pero es el viaje lo que importa.", "Aunque técnicamente perdiste, ¡para nosotros eres medio ganador!", "Quedan dos preguntas. Hazlo por el orgullo.", "Te habíamos catalogado como un jugador intermedio, ¡y mira! ¡Lo eres!", "Tres de cinco. ¡Agarra tu amuleto y encuentra la fuerza para continuar!"],
    ...
    reaction55: ["Dos preguntas para la perfección. Relájate y sé uno con el Fibbage.", "¿Eres quizás un carpintero o un contratista general? Porque estás dando en el clavo.", "Solo dos más. ¡Estamos tan nerviosos por ti!", "¡Puntaje perfecto después de cinco! Ahora viene la verdadera presión. No lo arruines.", "Wow, no podemos engañarte. Le echamos la culpa a las terribles mentiras que están poniendo los jugadores."],
    reaction06: ["Esto ha sido nada menos que un desastre total.", "Una vez más, te insultaríamos, pero no estamos seguros de que lo entenderías.", "Shhhhh. Todo terminará pronto.", "Mira, el pasado es el pasado. ¡El futuro es brillante!", "Hablemos de cualquier otra cosa que no sea tu puntaje."],
    reaction16: ["Está bien, solo necesitas una correcta más para pasar de asqueroso a apestoso.", "Buenas noticias: ¡Con este puntaje acabas de ganar el título de la persona más crédula del mundo!", "Una de seis. ¡Al menos no eres uno de esos perdedores que tiene cero!", "Solo una de seis. ¡Pero piensa en lo dulce que sería 2 de 7! ¡Huélelo!", "Una de seis. Sin embargo, ¡apostamos a que has aprendido mucho sobre tu persona!"],
    reaction26: ["¿Sabes qué? La próxima vez solo haz trampa.", "Está bien, no es tu mejor demostración\u2026 o al menos esperamos que esta no sea la mejor.", "Claro, podrías haber parado hace varias preguntas, pero ¡¿qué tiene de malo la vergüenza?!", "No estamos seguros de qué te motiva, ¡excepto que obviamente no es la voluntad de alcanzar la perfección!", "Promedio. Vainilla. Neutral. Cualquiera de esos adjetivos es demasiado bueno para tu desempeño."],
    reaction36: ["La mayoría de la gente habría mirado este puntaje feo y se habría dado por vencido. ¡Qué manera de soportarlo!", "Tres de seis. ¡Te debemos la mitad de unas felicidades!"],
    ...
    reaction56: ["¡Contesta bien la próxima, para que la que erraste te duela aún más!", "5 de 6 es bastante bueno. Sin sentido y sin recompensa, ¡pero bastante bueno!", "¡Cinco de seis! No se nos permite hacer trofeos para eso, ¡así que haz el tuyo!", "¡Solo le erraste a una! Lástima que no nos puedan sobornar para cambiarlo\u2026 ¿o sí? Conoces nuestra dirección."],
    reaction66: ["¡Solo queda una más! ¡No te derrumbes bajo la presión como muchos antes que tú!", "¡Ahora no lo arruines porque sino estropearás el mejor momento de tu vida!", "¡Eres una máquina de Fibbage bien aceitada! ¡Te ves grasoso pero el aceite hará eso!", "¡6 de 6! ¡No estás cayendo con estas débiles mentiras!", "Aparentemente, has confundido a Fibbage con una alfombra vieja, ¡porque la estás rompiendo!", "¿Estás listo para la fama de Fibbage? Si no es así, sal ahora o dale el control a un idiota.", "¡Perfecto después de seis! ¡La gloria eterna está a solo una pregunta de distancia!", "¡Perfecto después de seis! ¡Qué loco viaje ha sido este! ¡Estamos armando un montaje conmovedor ahora mismo!"],
    reaction07: ["Nunca más hablemos de esto.", "Un huevo de ganso grande. No, ¿sabes qué? No insultaremos un huevo perfectamente bueno así.", "¡Lo hiciste! ¡¡¡Fallaste de la manera más completa posible!!!", "¡Lo hiciste! ¡Cero de siete! ¡Toma eso, éxito!", "Aplauso lento.", "Al menos te divertiste, ¿verdad? Probablemente no.", "La gente dijo que no se podía hacer, ¡pero demostraste que estaban equivocados!"],
    ...
    reaction57: ["Lamentamos que no hayas ganado, pero viendo el lado positivo, ¡nadie esperaba que ganaras de todos modos!", "Solo le erraste a dos, pero para que recuerdes: se suponía que no le erraras a ninguna.", "Bueno, solo le erraste a dos. Dos grandes e irrevocables errores.", "Ahora tienes algo por lo que eforzarte en tu tiempo libre.", "No los mires como dos errores. Míralos como dos tonterías. Las tonterías son más divertidas.", "¡Parcialmente moderadamente respetable!"],
    reaction67: ["¡Seis de siete! No es diferente a obtener cero de siete, pero aun así, buen trabajo.", "¡¡¡Estuviste tan cerca!!! Lo importante es no pensar en ello esta noche en tus pesadillas.", "¡Tan cerca! Ese es el tipo de cosa que volvería loca a la mayoría de las personas. Oh bueno. ¡Que tengas un buen día!", "Quizás no te des cuenta de esto, pero 6/7 es lo más cercano que puedes obtener a un puntaje perfecto sin obtener uno.", "Esto te hará más fuerte o te destruirá por completo. Envíanos una postal y háznoslo saber.", "Hay una lección aquí. No estamos seguro de cuál. Pero la hay, probablemente."],
    events: {
